        ...
        <form method="POST" action="<?= base_url('peminjaman/simpan') ?>" class="form-horizontal">
            <div class="box-body">
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">Id Peminjaman</label>
                    <div class="col-sm-8">
                        <input type="text" name="id_pm" value="<?= $id_peminjaman; ?>" class="form-control" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">Peminjam</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">Buku</label>
                    <div class="col-sm-8">
                        <select name="id_buku" id="id_buku" class="form-control select2" id="">
                ...
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">Tanggal peminjaman</label>
                    <div class="col-sm-8">
                        <input type="date" name="tgl_pinjam" value="<?= $tgl_pinjam ?>" class="form-control" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">Tanggal Pengembalian</label>
                    <div class="col-sm-8">
